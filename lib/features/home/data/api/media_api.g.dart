...
class _MediaApi implements MediaApi {
  ...
  Future<HttpResponse<MovieRatedModel>> getMovieDetail(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<MovieRatedModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late MovieRatedModel _value;
    try {
      _value = MovieRatedModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<TvRatedModel>> getTvDetail(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<TvRatedModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TvRatedModel _value;
    try {
      _value = TvRatedModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
